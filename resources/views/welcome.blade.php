...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div id="app" class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
            @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <svg class="md:mx-5 h-16 w-auto text-gray-700 sm:h-20" viewBox="0 0 273 64" fill="none" xmlns="http://www.w3.org/2000/svg"><title>Tailwind CSS</title>
